    ...
    return (
        <main className="min-h-screen bg-white">
            ...
            <div className="container mx-auto px-8 lg:px-24 pt-16 pb-12">
                <PageTitle className="mb-6">{t.contactoPage.titulo}</PageTitle>
                <p className="text-lg text-gray-600 max-w-2xl mx-auto text-center">
                    {t.contactoPage.subtitulo}
                </p>
            </div>
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="bg-white border border-gray-100 rounded-xl p-6 shadow-sm hover:shadow-md transition-shadow">
                                ...
                                <ul className="space-y-6">
                                    <li className="flex items-start gap-4">
                                        ...
                                        <div>
                                            <span className="block text-sm font-bold text-gray-900 mb-1">{t.contactoPage.direccion}</span>
                                    ...
                                    <li className="flex items-start gap-4">
                                        ...
                                        <div>
                                            <span className="block text-sm font-bold text-gray-900 mb-1">{t.contactoPage.telefono}</span>
                            ...
                            <div className="bg-gray-900 text-white rounded-xl p-6 shadow-lg">
                                ...
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        <span className="block text-sm font-bold text-gray-300 mb-1">{t.contactoPage.dias}</span>
                                        <span className="text-xl font-medium text-white">{t.contactoPage.horas}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
